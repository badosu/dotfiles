...
vim.fn.setenv('GEM_HOME', '/home/badosu/.local/share/gem/ruby/3.0.0/bundle')
vim.fn.setenv('PERL5LIB', '/home/badosu/perl5/lib/perl5' .. (vim.env.PERL5LIB and ':' .. vim.env.PERL5LIB or ''))
vim.fn.setenv('PERL_LOCAL_LIB_ROOT', '/home/badosu/perl5' .. (vim.env.PERL_LOCAL_LIB_ROOT and ':' .. vim.env.PERL_LOCAL_LIB_ROOT or ''))
vim.fn.setenv('PERL_MB_OPT', '--install_base \"/home/badosu/perl5\"')
vim.fn.setenv('PERL_MM_OPT', 'INSTALL_BASE=/home/badosu/perl5')
